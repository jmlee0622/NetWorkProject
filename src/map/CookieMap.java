	    ...
	    Runnable runnable = new Runnable() {
	        ...
	        public void run() {
	            ...
	            try { 
	                ...
	                bupp = new JLabel(new ImageIcon(bupImg));
	                br = new JLabel(new ImageIcon(brightImg));
	                bd = new JLabel(new ImageIcon(bdownImg));
	                bl = new JLabel(new ImageIcon(bleftImg));
	                bc = new JLabel(new ImageIcon(bcenterImg));
